...
CREATE TABLE game_config (
  ...
  app_version VARCHAR(20) NOT NULL DEFAULT 'v0.4.9',
...
INSERT INTO game_config (config_id, day_length_seconds, shop_refresh_minutes, day_start_hour, sun_icon, moon_icon, goblin_icon, pouch_icon, app_version, max_available_orders, order_board_min_minutes, order_board_max_minutes, order_refill_min_minutes, order_refill_max_minutes, order_normal_min_minutes, order_normal_max_minutes, order_rush_min_minutes, order_rush_max_minutes, order_late_fee_percent, order_rush_bonus_percent, map_background_image, map_button_positions_json)
VALUES (1, 720, 60, 6, '☀️', '🌙', '🧌', '👝', 'v0.4.9', 5, 3, 8, 2, 5, 30, 120, 15, 30, 20, 20, NULL, '{"orders":[298,105],"helpers":[475,125],"shop":[110,290],"garden":[298,298],"shed":[485,290],"bone_brine":[90,510],"market":[298,500],"caravan":[470,510]}');
